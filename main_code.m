...
p2 = [18;18];   %second point

end
if s == 13
p1 = [18;18]; %first point
p2 = [18;6];   %second point
end
if s == 14
p1 = [18;6]; %first point
p2 = [18;12];   %second point 
end
if s==15
p1 = [18;12]; %first point
p2 = [16;12];   %second point 
end
if s == 16
p1 = [16;12]; %first point
p2 = [20;12];   %second point
end
if s == 17
p1 = [20;12]; %first point
p2 = [22;18];   %second point
end
if s == 18
p1 = [22;18]; %first point
p2 = [22;6];   %second point
end
%%%%%%%%%88888
if s == 19
p1 = [22;6]; %first point
p2 = [24;6];   %second point
end
...
if s == 21
p1 = [24;14]; %first point
p2 = [24;18];   %second point

end

if s == 22
p1 = [24;18]; %first point
p2 = [27;18];   %second point
...
[theta1_1,theta2_1,theta1_2,theta2_2] = IKnFunction(px_array(1),py_array(1),a1,a2);
 ...
 theta1_previous = theta1_2 ; theta2_previous = theta2_2 ;  
...
for i = 1:k*n
    ...
    hold off ; 
%%writePosition(s2,(theta1_array_deg(i)/180));
%%writePosition(s1,((theta2_array_deg(i)+180)/180));
